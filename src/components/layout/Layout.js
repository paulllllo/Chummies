        ...
        <div className={styles.Layout}>
            <section className={`${styles.Header} + container`}>
                <div className={styles.LogoBlock}>
                    ...
                    <span className={styles.SiteName} onClick={() => navigate('/')}>Chummies</span>
                </div>
            ...
            <section className={styles.Footer}>
                <div className="container">
                    <span className={styles.SiteName}>Chummies</span>
                    <p className={styles.Slogan}>taste the memories</p>
                </div>
            </section>
        </div>
    )
